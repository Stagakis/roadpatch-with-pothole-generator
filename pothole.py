...
pothole = readPointCloud('model_2.ply')
...
savePointCloud("dense_road.ply", dense_road)
#print(dense_road)

final_xyz = np.concatenate( (pothole, dense_road), axis=0)
savePointCloud("final.ply", final_xyz)
